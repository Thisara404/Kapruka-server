...
import { DeactivatedUser, DeactivatedUserSchema } from './schemas/deactivated-user.schema';
...
@Module({
  imports: [
    MongooseModule.forFeature([{ name: DeactivatedUser.name, schema: DeactivatedUserSchema }]),
    UsersModule,
    ChatModule,
    AnalyticsModule,
    AuthModule,
